...
function buildCowsSummary(cows: ReturnType<typeof useCows>["cows"], ingredients: Ingredient[]) {
  return cows.map(c => {
    const n = calcNutrition(c.diet, ingredients);
    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          max_tokens:1000,
          system: buildSystemPrompt(buildCowsSummary(cows, ingredients)),
